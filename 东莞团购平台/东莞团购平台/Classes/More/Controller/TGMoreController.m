...
//        //进入扫一扫界面控制器
//        TGScanController *scan = [[TGScanController alloc]init];
//        
//        scan.view.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height + 60);
//        scan.view.backgroundColor = kGlobalBg;
