...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"goToFollow@2x.png"] style:UIBarButtonItemStylePlain target:self action:@selector(backClick)];
