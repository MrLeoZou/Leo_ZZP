...
{
    return @{@"totalCitySections":[TGCitySection class],@"totalCategories":[TGCategory class],@"totalOrders":[TGOrder class]};
}
...
-(void)loadCityData
{
    ...
    for (NSDictionary *azDict in azArray) {
        ...
        TGCitySection *citySection = [TGCitySection objectWithKeyValues:azDict];
...
-(void)loadCategoryData
{
    ...
    for (NSDictionary *dict in array) {
        //找出字典中对应值赋值给category的属性
        TGCategory *c = [TGCategory objectWithKeyValues:dict];
        [tmp addObject:c];
    }
