...
-(void)baseSetting
{
    ...
    [UIBarButtonItem itemWithIcon:@"btn_share.png" highlightedIcon:@"btn_share_pressed.png" target:self action:@selector(shareBtnOnClick)],
...
/*
 ->新浪微博
 App Key：2657053187
 App Secret：931d5cffbdab703ccd104699c74e383c
 应用地址：http://www.baidu.com
 
 */
- (void)shareBtnOnClick
{
//    [ShareSDK  connectSinaWeiboWithAppKey:@"2657053187"
//                                appSecret:@"931d5cffbdab703ccd104699c74e383c"
