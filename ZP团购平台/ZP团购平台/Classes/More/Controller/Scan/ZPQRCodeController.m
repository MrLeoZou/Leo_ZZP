...
#import "ZPQRCodeController.h"
#import <AVFoundation/AVFoundation.h>
#import "TGWebViewController.h"

@interface ZPQRCodeController ()<AVCaptureMetadataOutputObjectsDelegate>
///  定时器
...
@implementation ZPQRCodeController
...
//    DDLogInfo(@"二维码 -- %s",__func__);
    if (self.constraint.constant < -170) {
